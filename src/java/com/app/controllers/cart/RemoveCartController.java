...
public class RemoveCartController extends HttpServlet {
    ...
    private static final String SUCCESS = "MainController?action=view";
...
//                shoppingCart.delete(id);
                shoppingCart.delete(Integer.parseInt(index));
                session.setAttribute("shoppingCart", shoppingCart);
                url = SUCCESS;
            } else {
                request.setAttribute("VERIFY_DELETE", "You must login to delete");
            }
        } catch (Exception e) {
        } finally {
